 ...
 */
@Module({
  imports: [MembershipModule, TypeOrmModule.forFeature([ClinicalRecord, Alert, Notification])],
  controllers: [CareRecordController, NotificationController],
  providers: [CareRecordAccess, RangeAccess, AlertAccess, AlertEngine, CareRecordManager],
